...
/* Downloaded from http://www.mit.edu/afs/sipb/contrib/postscript/Adobe/Programs/parseAFM/
 * on Thu Aug 22 2002. A small program which demonstrates this "library"
 ...
 *  modified: mh   Tue Sep 10 22:25:11 CEST 2002
 *    - small changes to make code pass "gcc -Wall"
 */
...
/* Not used, thus does not pass gcc -Wall
 *    -mh
 */
#if 0 
...
/* name changed to conform to Zen namespace
 *   -mh
 */
extern int psdump_parseFile (fp, fi, flags)
  FILE *fp;
  FontInfo **fi;
  FLAGS flags;
{
